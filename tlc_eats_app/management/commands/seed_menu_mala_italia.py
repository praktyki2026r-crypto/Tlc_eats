...
MENU = {
    ...
    'Dania główne': [
        ...
        ('Chicken Ocini', 39.5, 'filet z kurczaka / sos pieczarkowy / śmietanka / białe wino / posypany pudrem z leśnych grzybów / grillowane warzywa / mix sałat'),
    ...
    'Sałatki': [
        ...
        ('Sałatka Tuna Nicoise', 38.5, 'mix sałat / tuńczyk / pomidor / ogórek / oliwki / czerwona cebula / anchovies / kapary / jajko w koszulce / opiekany ziemniak / oliwa / ocet balsamiczny'),
    ],
    'Dodatki': [
        ('Frytki', 9.0, '',[('250g', 0)] ,[]),
