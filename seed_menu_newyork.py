...
MENU = {
    'Zestawy Śniadaniowe': [
        ...
        ('I Zestaw', 12.00, 'jajecznica z 3 jajek na boczku lub maśle, ogórek, pomidor, pieczywo, masło', [], []),
        ('II Zestaw', 12.00, 'kiełbasa na gorąco, pieczywo, masło, musztarda, ketchup', [], []),
        ('III Zestaw', 12.00, 'kiełbasa smażona z cebulą, pieczywo, masło, ketchup, musztarda', [], []),
        ('IV Zestaw', 10.00, 'parówki drobiowe 2 szt., ogórek, pomidor, pieczywo, masło', [], []),
        ('V Zestaw', 11.00, 'jajko sadzone 2 szt., ogórek, pomidor, pieczywo, masło', [], []),
    ],
    'Napoje Gorące': [
        ('Kawa Ristretto', 7.00, '', [], []),
    ...
    'Zestawy Obiadowe': [
        ...
        ('Wątróbka panierowana', 20.00, 'do wyboru: ziemniaki, frytki lub ryż, surówka', [], []),
        ('Wątróbka z cebulą', 22.00, 'do wyboru: ziemniaki, frytki lub ryż, surówka', [], []),
